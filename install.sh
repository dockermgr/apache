...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/apache"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="apache"
INSTDIR="$HOME/.local/share/dockermgr/apache"
APPDIR="$HOME/.local/share/srv/docker/apache"
DATADIR="$HOME/.local/share/srv/docker/apache/files"
...
HUB_URL="casjaysdevdocker/apache:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "apache"; then
